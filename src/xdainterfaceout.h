...
#ifndef XDAINTERFACEOUT_H
#define XDAINTERFACEOUT_H

#include <ros/ros.h>

#include "xdacallback.h"
#include "mastercallback.h"			//  header with Callback handler for wireless master
#include "mtwcallback.h"			//	header with Callback handler for MTw
